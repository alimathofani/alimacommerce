            ...
            <form class="form-horizontal" action="{{ route('product.store') }}" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group has-feedback{{ $errors->has('description') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                    <textarea name="description" id="" rows="5" class="form-control" placeholder="Description" >{{ old('description') }}</textarea>
                ...
                <div class="form-group has-feedback{{ $errors->has('discount') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="discount" placeholder="Discount" name="discount" value="{{ old('discount') }}">
                ...
                <div class="form-group has-feedback{{ $errors->has('quantity') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="quantity" placeholder="Name of Product" name="quantity" value="{{ old('quantity') }}">
